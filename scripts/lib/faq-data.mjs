...
export const FAQ = {
	...
	"guides/ai-for-the-skeptical-owner/index.html": {
		...
		items: [
			{ q: "Do most AI projects really fail?", a: "Yes. Boston Consulting Group's October 2024 study Where's the Value in AI? found that 74% of companies have yet to show tangible value from their use of AI; only 26% have built the capabilities to move beyond proofs of concept." },
			...
			{ q: "Is skepticism a problem when adopting AI?", a: "The opposite. Demanding proof, rejecting vendor magic, and keeping a named person accountable are the traits that separate working projects from the 74% that have yet to show tangible value." },
		],
	},
	...
	"industries/healthcare/index.html": {
		...
		items: [
			...
			{ q: "Where does our patient data go?", a: "Nowhere. The models run on hardware in your building, bought in your name, so a record read by that machine has not left your environment. A Presidio-class privacy filter strips identifiers before any model reads a document, everything stored is encrypted at rest, and every action writes to an append-only, tamper-evident log." },
