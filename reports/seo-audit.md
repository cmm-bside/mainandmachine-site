...
| `/denver/` `/phoenix/` | ProfessionalService `…/#local` with `areaServed` City→State, priceRange `$3,500 - $45,000`, telephone `+1-928-363-6639`, `parentOrganization → #org`; FAQPage; BreadcrumbList. **No PostalAddress/geo by design** — no verified street addresses exist; omitted rather than faked (see CLAUDE.md TODO). |
...
$12,000–$45,000), phone (928-363-6639), cities, ~90 days, and the free assessment
