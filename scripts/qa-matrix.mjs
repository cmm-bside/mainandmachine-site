...
const audit = (cfg) => {
	...
	const SECTION_Y_EXEMPT = [
		...
		{ sel: "section.pagehero", top: "96px", bottom: "96px" },
		{ sel: "section.sechero", top: "96px", bottom: "96px" },
		{ sel: "section.cr-hero", top: "96px", bottom: "96px" },
		{ sel: "section.story-hero", top: "96px", bottom: "96px" },
		{ sel: "section.thankshero", top: "96px", bottom: "96px" },
		{ sel: "section.bloghero", top: "96px", bottom: "96px" },
		// Single-section pages: 96 on top, and the bottom is the page's last
		// closing step, so it keeps --section-y like every other final section.
		{ sel: "section.legal-hero", top: "96px", bottom: null },
		{ sel: "section.nf", top: "96px", bottom: null },
		// Genuine thin banners — the one padding override the VERTICAL RHYTHM
		// LAYER allows. Each is a single line of mono text between hairlines
		// (the city NAP line, "also serving" and "from the catalog" link rows),
		// generated by scripts/render-cities.mjs and build-build-pages. They
		// shipped 2026-08-09 without being named here and failed this check
		// silently on ~20 routes until the 2026-09-01 rhythm pass.
		{ sel: "section.napband", top: "32px", bottom: "32px" },
		{ sel: "section.citylinks", top: "32px", bottom: "32px" },
		{ sel: "section.buildlinks", top: "32px", bottom: "32px" },
	];
